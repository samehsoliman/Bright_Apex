...
******************************************************************************/
    ...
    FUNCTION GET_BASIC_SALARY_DAY_VALUE(V_EMPLOYEE_ID NUMBER, V_DATE DATE) RETURN NUMBER ;
    FUNCTION GET_CALCULATION_METHOD RETURN NUMBER;
    FUNCTION GET_DAY_ABSENT_VALUE(V_EMPLOYEE_ID NUMBER, V_DATE DATE ) RETURN NUMBER;
    FUNCTION GET_DAY_LATE_VALUE(V_EMPLOYEE_ID NUMBER, V_DATE DATE ) RETURN NUMBER ;
    FUNCTION GET_DAY_PENALTY_VALUE(V_EMPLOYEE_ID NUMBER, V_DATE DATE ) RETURN NUMBER;
    FUNCTION GET_DAY_PER_MONTH(V_DATE DATE) RETURN NUMBER;
    FUNCTION GET_DAY_REWARD_VALUE(V_EMPLOYEE_ID NUMBER, V_DATE DATE ) RETURN NUMBER ;
    FUNCTION GET_EMP_SCHEDULE(V_EMPLOYEE_ID NUMBER, V_DATE DATE) RETURN NUMBER;
    FUNCTION GET_HOURS_PER_DAY(V_EMPLOYEE_ID NUMBER) RETURN NUMBER;
    FUNCTION GET_OVERTIME_FACTOR RETURN NUMBER;
    FUNCTION GET_OVERTIME_HOUR_VALUE(V_EMPLOYEE_ID NUMBER, V_DATE DATE, V_OVERTIME_FACTOR IN OUT NUMBER ) RETURN NUMBER;
...
/******************************************************************************  
   NAME:       PCK_PAYROLL  BODY 
   PURPOSE:   PACKAGE AS PLL IN FORMS ERP 
   CRETAED BY: AHLAM ABDULLAH GOMAH 
******************************************************************************/
  
FUNCTION GET_BASIC_SALARY_DAY_VALUE(V_EMPLOYEE_ID NUMBER, V_DATE DATE) RETURN NUMBER IS
CURSOR C1 IS
    SELECT SUM(AMOUNT)
...
V_AMOUNT NUMBER;
BEGIN
    V_DAY_PER_MONTH := GET_DAY_PER_MONTH(V_DATE);
    OPEN C1;
...
BEGIN
    ...
    V_DAY_PER_MONTH := GET_DAY_PER_MONTH(V_DATE);
    V_HOURS_PER_DAY := GET_HOURS_PER_DAY(V_EMPLOYEE_ID);
    
    IF V_OVERTIME_FACTOR IS NULL THEN
            V_OVERTIME_FACTOR := GET_OVERTIME_FACTOR();
    END IF;
